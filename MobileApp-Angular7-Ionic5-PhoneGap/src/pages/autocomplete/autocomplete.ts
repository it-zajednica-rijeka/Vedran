...
export class AutocompletePage {
    ...
    chooseItem(item: any) {
        ...
        googlePlacesService.getDetails({
            ...
            if (details) {                
                ...
                // item.lat = 45.36478031;
                // item.lng = 14.30136144;
    ...
    updateSearch() {
        ...
        let me = this;
        this.service.getPlacePredictions({ input: this.autocomplete.query, componentRestrictions: { country: 'HR' } }, function (predictions, status) {
